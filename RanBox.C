...
// added c_ZPL_R2_SvsBKG == 3  <=> use Upper Limit Test statisitc !

void RanBox(int dataset = 0, int Ntrials = 1000, int Nsignal = 200, int Nbackground = 9800, int Algorithm = 5, bool useZPL = false,
            bool useSB = true, bool PCA = false, int Nvar = 8, int Nremoved = 0, int speedup = 1, int NH0 = 1, int c_ZPL_R2_SvsBKG = 3, bool one_off = false)
{
